...
<div class="col-xs-10" id="mailListDetailCss">
	...
	<%-- 이전글, 다음글 영역 --%>
		<div style="margin-top: 400px;">
			<span class="move" onclick="javascript:location.href='mailSendToMeDetail.bts?pk_mail_num=${requestScope.mailvo.prev_seq}&searchType=${requestScope.paraMap.searchType}&searchWord=${requestScope.paraMap.searchWord}'"><i class="fa fa-sort-desc" aria-hidden="true"></i>&nbsp;&nbsp;이전글제목 : ${requestScope.mailvo.prev_subject}</span>
			<hr>
			<span class="move" onclick="javascript:location.href='mailSendToMeDetail.bts?pk_mail_num=${requestScope.mailvo.next_seq}&searchType=${requestScope.paraMap.searchType}&searchWord=${requestScope.paraMap.searchWord}'"><i class="fa fa-sort-desc" aria-hidden="true"></i>&nbsp;&nbsp;다음글제목 : ${requestScope.mailvo.next_subject}</span>
			<br/>
		</div>
	</div>
</div>
