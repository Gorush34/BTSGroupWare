...
<div class="container" style="width: 100%; margin: 50px;">
		<div class="row bg-title" style="border-bottom: solid 1.5px #e6e6e6;">	
			...
			<div id="goList">
				...
				<button type="button" id="btnGoList" class="btn btn-secondary btn-sm" onclick="location.href='<%= ctxPath%>/mail/mailSendList.bts'" style="margin-left: 1040px; margin-bottom: 5px; ">
				목록
				</button>
			</div>	
		</div>	
