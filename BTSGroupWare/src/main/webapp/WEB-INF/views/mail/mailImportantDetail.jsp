...
<div class="col-xs-10" id="mailListDetailCss">
		<div style="border-bottom: solid 1.5px #e6e6e6;" style="width: 90%;">	
			...
			<div id="goList">
				...
				<button type="button" id="btnGoList" class="btn btn-secondary btn-sm" onclick="location.href='<%= ctxPath%>/mail/mailImportantList.bts'" style="margin-left: 1360px; margin-bottom: 5px; ">
				목록
				</button>
			</div>	
		</div>	
	...
	<%-- 이전글, 다음글 영역 --%>
		<div style="margin-top: 400px;">
			<span class="move" onclick="javascript:location.href='mailImportantDetail.bts?pk_mail_num=${requestScope.mailvo.prev_seq}&searchType=${requestScope.paraMap.searchType}&searchWord=${requestScope.paraMap.searchWord}'"><i class="fa fa-sort-desc" aria-hidden="true"></i>&nbsp;&nbsp;이전글제목 : ${requestScope.mailvo.prev_subject}</span>
			<hr>
			<span class="move" onclick="javascript:location.href='mailImportantDetail.bts?pk_mail_num=${requestScope.mailvo.next_seq}&searchType=${requestScope.paraMap.searchType}&searchWord=${requestScope.paraMap.searchWord}'"><i class="fa fa-sort-desc" aria-hidden="true"></i>&nbsp;&nbsp;다음글제목 : ${requestScope.mailvo.next_subject}</span>
			<br/>
		</div>
	</div>
</div>
