...
<div class="edmsDiv">
   ...
   <div class="edmsHomeTitle">
      <span class="edms_maintitle">문서수정</span>
   ...
   <input type="text" name="pk_appr_no" value="${requestScope.apprvo.pk_appr_no}" />
	...
	<table style="width: 100%" class="table table-bordered">
      ...
      <tr>
         ...
         <td colspan="4">
         	<input type="hidden" name="fk_mid_empno" id="fk_mid_empno" class="form-control" value="${requestScope.apprvo.fk_mid_empno}" readonly />
         	<input type="text" name="fk_mid_empno2" id="fk_mid_empno2" class="form-control" value="${requestScope.apprvo.fk_mid_empno}" readonly />
         </td>
      </tr>
      
      <tr>
         <td colspan="4">
         	<input type="hidden" name="fk_fin_empno" id="fk_fin_empno" class="form-control" value="${requestScope.apprvo.fk_fin_empno}" readonly />
         	<input type="text" name="fk_fin_empno2" id="fk_fin_empno2" class="form-control" value="${requestScope.apprvo.fk_fin_empno}" readonly />
        </td>
      </tr>
      ...
      <tr>
         ...
         <td colspan="4">
            <input type="text" name="title" id="title" size="100" style="width: 100%;" class="form-control"  value="${requestScope.apprvo.title}" />
         </td>
      </tr>
      <tr>
         <th class="edmsView_th">내용</th>
         <td colspan="4">
            <textarea style="width: 100%; height: 612px;" name="contents" id="contents" class="form-control">${requestScope.apprvo.contents}</textarea>
         </td>
      </tr>
      
      <tr>
         <th class="edmsView_th"><label for="attach">파일첨부</label></th>
         	<c:if test="${requestScope.apprvo.filename ne ''}">
				<td colspan="4">
					<input type="text" class="form-control-plaintext" size="100" style="width: 40%;" value="${requestScope.apprvo.filename}" />
					
					<input type="file" name="attach" id="attach" class="form-control-file" style="width: 60%;" />
				</td>
			</c:if>
		
			<c:if test="${requestScope.apprvo.filename eq ''}">
				<td colspan="4">
