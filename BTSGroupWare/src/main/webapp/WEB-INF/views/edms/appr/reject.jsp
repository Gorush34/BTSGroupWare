	...
	<table style="width: 100%" class="table table-bordered">
		...
		<tr>
			<th class="edmsView_th">작성자</th>
          	<td colspan="4">
				...
				<input type="text" class="form-control-plaintext" name="name" value="${requestScope.apprvo.emp_name}" readonly />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2" style="width: 70%;">
				<input type="text" name="fk_mid_empno" class="form-control" placeholder="중간결재자 사번을 입력하세요" value="${requestScope.apprvo.fk_mid_empno}" readonly />
			</td>
...
<!-- 			<td style="width: 30%;">부서1 : 
		...
		<tr>
			<td>최종결재자</td>
			<td colspan="2" style="width: 70%;">
				<input type="text" name="fk_fin_empno" class="form-control" placeholder="최종결재자 사번을 입력하세요" value="${requestScope.apprvo.fk_fin_empno}" readonly />
			</td>
		</tr>
...
-->
		...
		<tr>
			...
			<td colspan="4">
				<input type="text" name="title" id="title" size="100" style="width: 100%;" class="form-control" placeholder="제목을 입력하세요" value="${requestScope.apprvo.title}"/>
			</td>
		</tr>
		<tr>
			<th class="edmsView_th">내용</th>
			<td colspan="4">
				<textarea style="width: 100%; height: 612px;" name="contents" id="contents">${requestScope.apprvo.contents}</textarea>
			</td>
		</tr>
		...
		<tr>
			...
			<c:if test="${requestScope.apprvo.filename ne ''}">
				<td>${requestScope.apprvo.filename}</td>
				<td colspan="4">
