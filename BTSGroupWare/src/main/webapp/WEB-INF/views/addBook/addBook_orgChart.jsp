...
<ul>
	<li class="list-group-item" id="head">B T S 그룹</li>
			<li class="list-group-item" id="tchteam" style="padding-left:100px;">강사팀</li>
				<li class="list-group-item" id="tchteam_one" style="padding-left:150px;">강사1팀</li>
					<li class="list-group-item" id="tchteam_one_ssjh" style="padding-left:200px;">서순신,서정화</li>
				<li class="list-group-item" id="tchteam_two" style="padding-left:150px;">강사2팀</li>
					<li class="list-group-item" id="tchteam_two_ssjh" style="padding-left:200px;">영순신,영정화</li>
				<li class="list-group-item" id="tchteam_three" style="padding-left:150px;">강사3팀</li>	
					<li class="list-group-item" id="tchteam_three_ssjh" style="padding-left:200px;">학순신,학정화</li>
			<li class="list-group-item" id="mngteam" style="padding-left:100px;">매니저팀</li>
				<li class="list-group-item" id="mngteam_one" style="padding-left:150px;">매니저1팀</li>
					<li class="list-group-item" id="mngteam_one_kdeu" style="padding-left:200px;">강길동,강이유</li>
				<li class="list-group-item" id="mngteam_two" style="padding-left:150px;">매니저2팀</li>
					<li class="list-group-item" id="mngteam_two_kdeu" style="padding-left:200px;">태길동,태이유</li>
				<li class="list-group-item" id="mngteam_three" style="padding-left:150px;">매니저3팀</li>
					<li class="list-group-item" id="mngteam_three_kdeu" style="padding-left:200px;">림길동,림이유</li>
			<li class="list-group-item" id="stuteam" style="padding-left:100px;">교육생팀</li>
				<li class="list-group-item" id="stuteam_one" style="padding-left:150px;">교육1팀</li>
					<li class="list-group-item" id="stuteam_one_hmmj" style="padding-left:200px;">정환모,김민정</li>
				<li class="list-group-item" id="stuteam_two" style="padding-left:150px;">교육2팀</li>
					<li class="list-group-item" id="stuteam_two_bymg" style="padding-left:200px;">문병윤,성문길</li>
				<li class="list-group-item" id="stuteam_three" style="padding-left:150px;">교육3팀</li>
					<li class="list-group-item" id="stuteam_three_yrje" style="padding-left:200px;">임유리,김지은</li>
</ul>
</div>
