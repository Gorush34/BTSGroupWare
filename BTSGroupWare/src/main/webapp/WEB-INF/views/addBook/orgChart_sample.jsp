...
//--------------------------- 중간결재자 버튼 시작 ---------------------------// 
		function middle_approve(){
		    ...
		    for(var i=0; i<empno.length; i++){
			    ...
			    html += '<td><input type="text" style="text-align:center; border:none;" readonly value = ' + name[i] + '></td>'
			    html += '<td><input type="text" style="text-align:center; border:none;" readonly value = ' + rank[i] + '></td>'
			    html += '<td><input type="text" style="text-align:center; border:none;" readonly value = ' + dept[i] + '></td></tr>'
...
//--------------------------- 최종결재자 버튼 끝 ---------------------------//		
			...
			<%-- $.ajax({
				url:"<%= ctxPath%>/addBook/orgChart_sample_ajax.bts",
				data:{"empno" : empno , "name" : name, "rank" : rank, "dept" : dept},
				type: "post",
				dataType: 'json',
				success : function(json) {
					$("input#middle_empno").val(empno);
				 	$("input#middle_name").val(name);
				 	$("input#middle_rank").val(rank);
				 	$("input#middle_dept").val(dept);
				},
			...
			<table style="text-align:center;">
		  	...
		  	<!-- 
		  		...
		  		<input type="text" id="emp_name" name="emp_name" />
		   		<input type="text" id="emp_rank" name="emp_rank" />
		   		<input type="text" id="emp_dept" name="emp_dept" />
		   	 -->	
	  	</div>
