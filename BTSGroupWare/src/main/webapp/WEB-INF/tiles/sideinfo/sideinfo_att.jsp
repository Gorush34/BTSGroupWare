...
<%--		else{
	...
	<%--	   <input type="hidden" value="${sessionScope }" id="fk_emp_no"> --%>
			...
			<button type="button" class="btn btn-outline-primary btn-lg " style="margin: 15px auto; width:200px; display:block;" onclick="javascript:location.href='<%= ctxPath%>/calendar/schedualRegister.bts'">버튼이요</button>
