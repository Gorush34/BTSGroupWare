...
<script type="text/javascript">
   ...
   function loopshowNowTime() {
      ...
      var timejugi = 1000;   // 시간을 1초 마다 자동 갱신
						...
						<table style="margin: 0 20px;">
							<tbody>
								<tr id="">
				   				...
				   				<tr id="">
				   					<td><span id="link" style="margin-left: 5px;"><a href="<%= ctxPath %>/emp/showAllEmp.bts">모든 사원보기</a></span></td>
				   				</tr>
				   				<tr>
				   					<td><span id="link" style="margin-left: 5px;"><a href="<%= ctxPath %>/att/viewAllReport.bts">모든 공가신청내역보기</a></span></td>
				   				</tr>	
		   				</tbody>	
	   				</table>	
				</div>
