...
public class ResourceDAO implements InterResourceDAO {
	...
	public List<Map<String, String>> resourceEdit(String pk_rno) {
		List<Map<String, String>> resourceList = sqlsession.selectList("jieun.resourceEdit", pk_rno);
		return resourceList;
	}
	...
	public int resourceEditEnd(Map<String, String> paraMap) {
		int n = sqlsession.update("jieun.resourceEditEnd", paraMap);
		return n;
	}
	...
	public int deleteResource(String pk_rno) {
		int n = sqlsession.delete("jieun.deleteResource",pk_rno);
		return n;
	}
