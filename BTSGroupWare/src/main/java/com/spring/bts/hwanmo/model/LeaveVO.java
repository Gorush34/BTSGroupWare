...
public class LeaveVO {
	...
	private float use_vac_days; /* 사용연차개수 */
	...
	public LeaveVO() {}
	public LeaveVO(int pk_vac_no, String total_vac_days, float use_vac_days, String rest_vac_days,
	...
	public float getUse_vac_days() {
		return use_vac_days;
	}
	public void setUse_vac_days(float use_vac_days) {
		this.use_vac_days = use_vac_days;
	}
