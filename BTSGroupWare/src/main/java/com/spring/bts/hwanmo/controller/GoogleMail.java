...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
        // recipient는 받는 사람의 이메일주소, certificationCode 는 이메일의 내용물(지금은 랜덤생성된 보안코드)
        ...
        prop.put("mail.smtp.user", "gorush34@gmail.com");
        ...
        // 제목 설정
        String subject = "localhost:9090/bts/index.bts 회원님의 비밀번호를 찾기위한 인증코드 발송";
        msg.setSubject(subject);
                
        // 보내는 사람의 메일주소
        String sender = "gorush34@gmail.com";
